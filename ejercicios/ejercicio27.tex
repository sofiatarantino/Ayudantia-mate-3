...
Es posible observar estas superficies y la región $W$ que encierran, en el siguiente enlace: \url{https://www.geogebra.org/3d/pwqrvt7x}.
\begin{figure}[htbp]
    \centering
    \includegraphics[width=0.7\textwidth]{ejercicios/Ejercicio27.png} 
    \caption{Figura de la región}
     \label{fig:mi_imagen}
     \end{figure}
