...
Donde las variables se restringen a $\rho \ge 0$, $0 \le \phi \le \pi$ y $0 \le \theta \le 2\pi$.
...
Dado que en el dominio de integración $\sin \phi \ge 0$, el factor de escala es simplemente $\rho^2 \sin \phi$. Por lo tanto, siguiendo el \textbf{Teorema de Cambio de Variables (2.5.10)}, el diferencial de volumen resulta:
